...
def test_blocked_edge_routing_changes_happen_through_world_state():
    ...
    cost, path = router.route(graph, 1, 3, world_state=world_state)
...
def test_same_map_can_be_used_with_independent_world_states():
    ...
    cost_a, path_a = router.route(graph, 1, 3, world_state=world_state_a)
    cost_b, path_b = router.route(graph, 1, 3, world_state=world_state_b)
...
def test_fresh_default_world_state_restores_baseline_behavior():
    ...
    rerouted_cost, rerouted_path = router.route(graph, 1, 3, world_state=world_state)
    baseline_cost, baseline_path = router.route(graph, 1, 3)
